...
addItem('&nbsp; BBSM', 'mBBSM', 'sm:');
addItem('&nbsp; Wireless', 'mWireless', 'sm:');

startMenu('mBBSM', true, 140, 0, 220, subM);
addItem('BBSM 5.2 Support Document', 'window.open("file://Lasdn-sd01/HTN Knowledgebase/Procedures & Documents/BBSM/BBSM 5.2 Support Document.doc")' , 'js:');
